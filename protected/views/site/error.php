                        ...
                        <div class="message-box">
                            ...
                            <div class="buttons-con">
                                <div class="action-link-wrap">
                                    <a onclick="history.back(-1)" href="" class="btn btn-custom btn-primary waves-effect waves-light m-t-20">Volver</a>
                                    <a href="<?php echo Yii::app()->createUrl('cruge/ui/login'); ?>" class="btn btn-custom btn-primary waves-effect waves-light m-t-20">P&aacute;gina de inicio</a>
                                </div>
                            </div>
                        </div>
                    </div>
