                        ...
                        <div class="row">  
                            <div class="col-md-12">
                                ...
                                <div id="modalLicense" class="modal fade" role="dialog" aria-labelledby="modalImageLabel" aria-hidden="true" style="display: none;">
									...
									<option value="LIC_ESPECIAL6">DIA DE LA SECRETARIA</option>
                                                                    </optgroup>
							    ...
							    <!-- seleccionar DIAS / HORAS   -->
							    <!-- DIAS MATRIMONIO -->
                                                            <div id="iniciodias_matri" style="display: none">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <label class="control-label">Fecha Inicio</label>
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control" id="lic_fch_ini_iniciodias_matri" name="lic_fch_matri" value="<?php echo date('d/m/Y 08:00');?>" required>
                                                                        </div><!-- input-group -->
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <label class="control-label">Fecha Fin</label>
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control" id="lic_fch_fin_iniciodias_matri"  name="lic_fch_matri" value="<?php echo date('d/m/Y 08:00');?>" required>
                                                                        </div><!-- input-group -->
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <label class="control-label">Fecha de Retorno</label>
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control" id="lic_fch_ret_iniciodias_matri" name="lic_fch_matri" value="<?php echo date('d/m/Y 08:00');?>" required>
                                                                        </div><!-- input-group -->
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <label class="control-label">D&iacute;as</label>
                                                                        <div class="input-group">
                                                                            <input type="text" maxlength="3" class="form-control" id="lic_day_iniciodias_matri" name="lic_d_matri" placeholder="0" readonly="readonly">
                                                                        </div><!-- input-group -->
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <label class="control-label">Horas</label>
                                                                        <div class="input-group">
                                                                            <input type="text" maxlength="2" class="form-control" id="lic_hour_iniciodias_matri" name="lic_h_matri" placeholder="0" readonly="readonly">
                                                                        </div><!-- input-group -->
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <label class="control-label">Minutos</label>
                                                                        <div class="input-group">
                                                                            <input type="text" maxlength="2" class="form-control" id="lic_minutes_iniciodias_matri" name="lic_m_matri" placeholder="0" readonly="readonly">
                                                                        </div><!-- input-group -->
                                                                        <span style="font-size:9pt;">Se acepta solo 0 &oacute; 30 minutos</span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <b style="font-size: 10pt; color:red;">Nota: Debe de ingresar las Fechas de Inicio, Fecha Fin y Fecha Retorno</b>
                                                                </div>
                                                            </div>
                                                            <!-- DIAS MATRIMONIO -->
                                                        </div>
...
jQuery(document).ready(function () {
    ...
    jQuery('#lic_fch_ini_iniciodias,#lic_fch_ini_vacacionesdias,#lic_fch_ini_vacacioneshoras,#lic_fch_ini_iniciodias_matri,#lic_fch_fin_iniciodias_matri,#lic_fch_ret_iniciodias_matri').datetimepicker({
...
function selectLicense(){
	...
	document.getElementById("iniciodias_matri").style.display = 'none';
	...
	document.getElementById('lic_fch_ini_iniciodias_matri').setAttribute('name', 'lic_fch_matri');
        document.getElementById('lic_fch_fin_iniciodias_matri').setAttribute('name', 'lic_fch_matri');
        document.getElementById('lic_fch_ret_iniciodias_matri').setAttribute('name', 'lic_fch_matri');
        document.getElementById('lic_day_iniciodias_matri').setAttribute('name', 'lic_d_matri');
        document.getElementById('lic_hour_iniciodias_matri').setAttribute('name', 'lic_h_matri');
        document.getElementById('lic_minutes_iniciodias_matri').setAttribute('name', 'lic_m_matri');
	...
	document.getElementById("iniciodias_matri").style.display = 'block';
        document.getElementById("vacaciones").style.display = 'none';

        document.getElementById("lic_day_iniciodias_matri").value = 10;        

        document.getElementById('lic_fch_ini_iniciodias_matri').setAttribute('name', 'lic_fch_ini');
        document.getElementById('lic_fch_fin_iniciodias_matri').setAttribute('name', 'lic_fch_fin');
        document.getElementById('lic_fch_ret_iniciodias_matri').setAttribute('name', 'lic_fch_ret');
        document.getElementById('lic_day_iniciodias_matri').setAttribute('name', 'lic_day');
        document.getElementById('lic_hour_iniciodias_matri').setAttribute('name', 'lic_hour');
        document.getElementById('lic_minutes_iniciodias_matri').setAttribute('name', 'lic_minutes');
	...
	document.getElementById("iniciodias_matri").style.display = 'none';
        ...
        document.getElementById("lic_obs").value = 'DIA DE LA SECRETARIA';
        document.getElementById("lic_obs").readOnly = true;
...
function calculateBetDays(){
    ...
    if(licencia  == 'LIC_ESPECIAL1' || licencia == 'LIC_ESPECIAL2'  || licencia == 'LIC_ESPECIAL3'  || licencia == 'LIC_ESPECIAL4'  || licencia == 'LIC_ESPECIAL5'  || licencia == 'LIC_ESPECIAL6'  || licencia == 'SOL_VACACION'   || licencia == 'LIC_SIN_GOCE_HABER' || licencia == ''){
